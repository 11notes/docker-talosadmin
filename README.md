...
services:
  admin:
    image: "11notes/talosadmin:1.0.4"
    <<: *lockdown
    environment:
      TZ: "Europe/Zurich"
      GOVC_URL: "${GOVC_URL}"
...
* [1.0.4](https://hub.docker.com/r/11notes/talosadmin/tags?name=1.0.4)
* [latest](https://hub.docker.com/r/11notes/talosadmin/tags?name=latest)
* [1.0.4-unraid](https://hub.docker.com/r/11notes/talosadmin/tags?name=1.0.4-unraid)
* [latest-unraid](https://hub.docker.com/r/11notes/talosadmin/tags?name=latest-unraid)
* [1.0.4-nobody](https://hub.docker.com/r/11notes/talosadmin/tags?name=1.0.4-nobody)
* [latest-nobody](https://hub.docker.com/r/11notes/talosadmin/tags?name=latest-nobody)

# REGISTRIES ☁️
```
docker pull 11notes/talosadmin:1.0.4
docker pull ghcr.io/11notes/talosadmin:1.0.4
docker pull quay.io/11notes/talosadmin:1.0.4
```
...
*created 21.08.2026, 08:25:07 (CET)*